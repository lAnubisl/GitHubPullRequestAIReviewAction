...
public sealed class ReviewPublisher : IReviewPublisher
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var summaryResult = await _commandRunner.RunAsync(
            new CommandSpec(
                "gh",
                new[]
                {
        ...
        {
            throw new ControlledFailureException(ExitCodes.GitHubFailure, $"Failed to publish review summary: {summaryResult.StandardError.Trim()}");
        }
